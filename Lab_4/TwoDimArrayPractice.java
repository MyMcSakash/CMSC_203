 ...
 * Description: Editing and displaying a TwoDimArray
 * Due: 3/26/2024
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
       ...
       return value; // replace this line with your return statement
   }//findMinimumn
	       ...
	       for ( int column = 0; column < intArray[row].length; column++ )
	        {
	           if(intArray[row][column]==value) {
	        	   repetition++;
	        	   animate( row, column, repetition );
	           }//if
	        }//for - 2nd
	   }//for - 1
	   return repetition; // replace this line with your return statement
   }
